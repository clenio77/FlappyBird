...
public class FlappyBird extends ApplicationAdapter {
        ...
        private  SpriteBatch batch; /*utilizado pra criar animaçoes*/
	...
	public void render () {
        ...
        //configurar dados de projeçoes da camera
        ...
        if (estadoJogo == 2){
            ...
            mensagem.draw(batch, "Toque para Reiniciar", larguraDispositivo / 2 - gameOver.getWidth() / 2 -100, alturaDispositivo / 2 - gameOver.getHeight() / 2);
        }
        batch.end();
